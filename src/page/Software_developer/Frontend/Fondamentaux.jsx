...
Chrome DevTools`,
  ...
  return (
    <div className="min-h-screen bg-slate-900 font-sans text-white selection:bg-blue-100">
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
        ...
        <header className="relative mb-12 px-4 text-center sm:mb-16 sm:px-6 lg:px-0">
          ...
          {/* Badge */}
          <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-blue-900 bg-blue-950 px-4 py-2 text-[10px] font-semibold uppercase tracking-widest text-white shadow-sm backdrop-blur-md sm:px-5 sm:text-xs">
            <Layout size={14} className="sm:h-4 sm:w-4" />
            <span>Module Fondamentaux</span>
          </div>

          {/* Title */}
          <h1 className="mx-auto max-w-4xl text-3xl font-black leading-tight tracking-tight text-swhite sm:text-5xl lg:text-6xl">
            Comprendre le{" "}
          ...
          {/* Description */}
          <p className="mx-auto mt-6 max-w-3xl text-base leading-relaxed text-slate-400 sm:mt-8 sm:text-lg lg:text-xl">
            ...
            return (
              <div
                ...
                className={`group overflow-hidden rounded-2xl border transition-all duration-300 ${
                  isExpanded
                    ? "border-blue-200 bg-slate-950 shadow-lg ring-1 ring-blue-50"
                    : "border-slate-200 bg-slate-950 hover:border-blue-900 hover:bg-slate-950"
                }`}
              >
                {/* Lesson Header */}
                <button
                ...
                {/* Lesson Content */}
                {isExpanded && (
                  <div className="border-t border-slate-100 bg-slate-950 p-6 animate-in fade-in slide-in-from-top-2 duration-300">
                      ...
                      <button
                        ...
                        className={`w-full py-3 rounded-xl font-bold transition-all ${
                          isCompleted
                            ...
                            : "bg-blue-400 text-white shadow-lg shadow-indigo-200"
                        }`}
                      >
                        {isCompleted
                          ? "Leçon terminée ✓"
        ...
        >
          <div className="relative overflow-hidden rounded-3xl border border-blue-500 bg-gradient-to-r from-blue-950 to-slate-950  p-5 shadow-lg sm:p-8">
            {/* Cercle décoratif */}
            <div className=" absolute -right-16 -top-16 h-40 w-40 rounded-full bg-slate-200/30 blur-3xl sm:-right-10 sm:-top-10"/>

            <div className="relative flex flex-col  gap-6 md:flex-row  md:items-center md:justify-between md:gap-8" >
              {/* Texte */}
               <div className=" flex flex-col  gap-4 sm:flex-row  sm:items-start">
                {/* Icon */}
                 <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-blue-500 text-white shadow-lg sm:h-16 sm:w-16">
              ...
              <button
                ...
                className=" group inline-flex w-full items-center  justify-center  gap-3  rounded-xl  bg-blue-500  px-7 py-3 font-semibold 
                  text-white transition  hover:bg-white-600 sm:w-auto md:shrink-0 ">
                Commencer
