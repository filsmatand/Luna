...
export default function Debutant() {
  ...
  return (
    <div className="min-h-screen px-24 bg-gray-950 font-sans text-slate-900 selection:bg-blue-100 ">

      {/* HERO */}
      <div className="mx-auto px-24 mb-16 max-w-5xl text-center">
        {/* Badge */}
        <div className="inline-flex mt-10 items-center gap-2 rounded-full border border-slate-200 bg-blue-950 px-5 py-2 text-sm font-semibold text-white">
          <Sparkles size={18} />
          Parcours Fullstack 2026
        </div>
